  ...
  render(){
    return (
     <View style={styles.container}>
            <Text style={styles.title}>Terms and conditions
            <hr/></Text>
            <ScrollView 
            ...
            >
                <Text style={styles.tcP}><hr/>
                  Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern [business name]’s relationship with you in relation to this website. If you disagree with any part of these terms and conditions, please do not use our website.</Text>
                <Text style={styles.tcP}>The term ‘E-Complaint forum’ or ‘us’ or ‘we’ refers to the owner of the website whose registered office is <a href='http://localhost:3000/contact'>address</a>. The term ‘you’ refers to the user or viewer of our website.</Text>
                    ...
                    <Text style={styles.tcL}>{'\u2022'} This website uses cookies to monitor browsing preferences. If you do allow cookies to be used, the following personal information may be stored by us for use by third parties: [such as your name, home address, email address, or telephone number].</Text>
...
Unauthorised use of this website may give rise to a claim for damages and/or be a criminal offence.</Text>
                    ...
                    <Text style={styles.tcL}>{'\u2022'} Your use of this website and any dispute arising out of such use of the website is subject to the laws of Indian Government.</Text>
                <Text style={styles.tcP}>The use of this website is subject to the following terms of use
                <hr/></Text>
            </ScrollView>
